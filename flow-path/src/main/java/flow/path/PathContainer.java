...
public abstract class PathContainer {
  ...
  public static final ViewState NULL_VIEW_STATE = new NullViewState();
   ...
   */
  public void clearAndShowPath(PathContainerView view, Path path, Flow.Direction direction,
  ...
  private static class NullViewState implements ViewState {
